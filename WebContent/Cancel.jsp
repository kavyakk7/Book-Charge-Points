...
<%
// Get bookings pertaining to the user from table 'booked' and display in a html table format with checkboxes
try
{
    ...
    Connection connection = null; 
  	...
  	if(rs!=null)
  	{
	    ...
	    <tbody>
  		...
  		%>
  		<tr>
  			<td><input type=checkbox name=bid value='<%=rs.getString(1)%>'></td>
